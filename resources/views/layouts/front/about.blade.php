            ...
            <div class="col-lg-12 col-12 mx-auto">
                ...
                <h6 class="mb-5">Meet Babers</h6>
                    ...
                    <div class="col-lg-5 col-12 custom-block-bg-overlay-wrap me-lg-5 mb-5 mb-lg-0">
                        <img src="http://facturacion.test/assets/front/images/barber/portrait-male-hairdresser-with-scissors.jpg" class="custom-block-bg-overlay-image img-fluid" alt="">
                    ...
                    <div class="col-lg-5 col-12 custom-block-bg-overlay-wrap mt-4 mt-lg-0 mb-5 mb-lg-0">
                        <img src="http://facturacion.test/assets/front/images/barber/portrait-mid-adult-bearded-male-barber-with-folded-arms.jpg" class="custom-block-bg-overlay-image img-fluid" alt="">
